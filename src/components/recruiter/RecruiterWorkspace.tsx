...
export default function RecruiterWorkspace({
  ...
  return (
    <div style={{ flex: 1, background: "#F7F7F8", maxWidth: "100%" }}>
        ...
        {activeTab === "creatives" && (
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr minmax(0, 320px)", gap: 18, alignItems: "start" }}>
              ...
              <div style={{ position: "sticky", top: 16, alignSelf: "start", maxHeight: "calc(100vh - 32px)", overflowY: "auto", minWidth: 0, marginTop: 8 }}>
                <LinkBuilderBar
                  requestId={request.id}
                  campaignSlug={request.campaign_slug}
                  activeChannel=""
      ...
      {/* Request New Assets Modal — structured form */}
      {showRequestModal && (
        <RequestAssetsModal
          requestId={request.id}
