...
interface DarkVeilProps {
  /** Shift the hue of the generated pattern (degrees). OneForma purple: ~270 */
  hueShift?: number;
  /** Grain noise intensity (0-1). Keep subtle. */
  noiseIntensity?: number;
  /** Scanline intensity (0-1). 0 = off. */
  ...
  warpAmount?: number;
  /** Resolution scale (0.5 = half res for performance) */
