...
export default function MockupPreview({ asset }: MockupPreviewProps) {
  ...
  const creative: MockupCreative = {
    ...
    headline: (content?.overlay_headline as string) || (content?.platform_headline as string) || (copyData?.headline as string) || (content?.headline as string) || (content?.slide_headline as string) || undefined,
    description: (content?.overlay_sub as string) || (content?.platform_description as string) || (copyData?.description as string) || (content?.subheadline as string) || undefined,
    primaryText: (copyData?.primary_text as string) || (content?.platform_description as string) || (content?.overlay_sub as string) || undefined,
    ctaText: (content?.overlay_cta as string) || (copyData?.cta as string) || (copyData?.cta_button as string) || (copyData?.cta_text as string) || (content?.cta_text as string) || "Apply Now",
