  ...
  // -------------------------------------------------------------------------
  {
    ...
    layoutData: {
      widgets: [
        ...
        w('paid-funnel',      'campaign-funnel',       'Campaign Funnel',       { days: 90 }),
      ...
      gridLayouts: responsiveLayouts([
        ...
        g('paid-roi',         6, 2,   6, 4),
        g('paid-funnel',      0, 6,  12, 8),
        g('paid-gallery',     0, 14, 12, 8),
        g('paid-campaigns',   0, 22, 12, 5),
        g('paid-utm',         0, 27,  6, 4),
        g('paid-leaderboard', 6, 27,  6, 4),
      ]),
    },
  },
